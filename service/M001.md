...
> Weather Phenomenon urn:aero:airm:1.0.0:ConceptualModel:Subjects:Meteorology:WeatherPhenomenon
...
The Weather Observation Data Service supports the following business functions:
...
The Weather Observations are available for all aerodromes within the Australian Flight Information Region.
...
The data services supports the following filtering options:

> Aerodrome - specify one or more ICAO Aerodrome codes in the subscription request to filter the Weather Observations to only those locations.
