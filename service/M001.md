...
The mesage exchange pattern for the service supports the following interfaces:
...
> Aerodrome - specify one or more ICAO Aerodrome codes in the subsciption request to filter the Weather Onservations to only those locations.
