...
---
# Service Name: Weather Observations ![](https://img.icons8.com/clouds/100/000000/windsock.png)
...
- Special Meteorological Report (SPECI), and
- Terminal Aerodrome Forecast (TAF)

These reporting constructs are as defined in ICAO Annex 3 / WMO No. 49-2.
...
The TAF is a format for reporting weather forecast information and are issued at least four times a day for major civil aerodromes and generally apply to a 24- or 30-hour period, and an area within approximately 8.0 km from the center of an airport runway complex. 
...
The Weather Observations and Predictions are available for all aerodromes within the Australian Flight Information Region.

##	Source of Information ![](https://img.icons8.com/dusk/64/000000/information.png)

All the original meteorological information is sourced from the [Australian Bureau of Meteorology](http://www.bom.gov.au).
...
The Data Service is open to any consumer to access and there are no restrictions on its use and re-use.
...
Message Validation | IWWXM V3.0 | Mandatory: Validate to [METAR, SPECI and TAF XML formats](http://schemas.wmo.int/iwxxm/3.0/)|
